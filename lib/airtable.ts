...
const FIELD_ALIASES: Record<string, string[]> = {
  ...
  invoice_total: ['Invoice Total', 'Client Invoice', 'Client Invoice Total', 'Total Price', 'Quote Total', 'Invoice Amount', 'Amount'],
...
function mapRecordToJob(record: AirtableRecord): NORPJob & { airtable_record_id: string; dashboard_order: string } {
  ...
  return {
    ...
    invoice_total: field(fields, FIELD_ALIASES.invoice_total),
