...
export function RecentWorkStatic() {
  const [hoveredId, setHoveredId] = useState<string | null>(null)

  return (
    <section id="recent-work" className="py-16 md:py-20 bg-card">
      <div className="max-w-7xl mx-auto px-6">
        {/* Header */}
        <div className="flex items-end justify-between mb-12">
          <div>
            <p className="text-accent font-mono text-sm uppercase tracking-[0.3em] mb-3">
              From the Press
            </p>
